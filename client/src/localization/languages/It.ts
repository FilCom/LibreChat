...
export default {
  ...
  com_endpoint_use_active_assistant: 'Usa l\'assistente predefinito',
  com_nav_welcome_assistant: 'Seleziona un Assistente',
  com_endpoint_assistant_placeholder: 'Seleziona un Assistente dal pannello in alto a sinistra',
  com_nav_my_files: 'I Tuoi File',
